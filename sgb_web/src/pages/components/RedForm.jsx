      ...
      <div className="redform_bg">
        ...
        <div className="redform_content">
          ...
          <div className="red_recom">
            <Link to="/redRecom">
              <img src={red_recom} alt="red_recom" width="300" height="100" />
            </Link>
          </div>
          {/* 과목이름 */}
          <label className="red-label">과목명을 적어줘!</label>
          <br />
          <input
          ...
          <br />
          {/* 기억에 남는 활동 */}
          <label className="red-label">수업 중 어떤 활동이 기억에 남아?</label>
          <br />
          <input
          ...
          <br />
          {/* 활동날짜 */}
          <label className="red-label">활동 날짜와 기간도 기록하자.</label>
          <br />
          <input className="red_date_input" type="date" ref={redStartDate} />
          &nbsp;~&nbsp;
          <input
          ...
          {/* 활동소감 (선택) */}
          <label className="red-label">
            배우고 성장한 점, 나아가 더 공부해본 영역도 함께 남겨두자! :) (선택)
          </label>
          <textarea
