    ...
    <div className="pinkform">
      <div className="pinkform_bg">
        ...
        <div className="pinkform_content">
          ...
          <br />
          {/* 수상날짜 */}
          <label className="green-label">수상날짜를 기록해주세요.</label>
          <br />
          <input
          ...
          {/* 수상비결 */}
          <label className="pink-label">
            수상한 비결이 궁금해요. 대회에서 특히 노력한 부분이나 활약한 영역이
            있다면 적어주세요.{" "}
          </label>
          <textarea
          ...
          {/* 활동소감 (선택) */}
          <label className="pink-label">
            수상실적과 관련해 기타 조언이 있다면 자유롭게 작성해주세요! (선택){" "}
          </label>
          <textarea
