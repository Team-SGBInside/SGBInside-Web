    ...
    <>
        ...
        <div className="infobox2">
          ...
          <div className="semester_menu">
            ...
            <div className="menu_btn">
              ...
              <Link to="/greenClickedMentor">
                <img src={menu_green} alt="green" width="80" height="40" />
                {""}
              </Link>
              <Link to="/pinkClickedMentor">
      ...
      <div className="mypage3">
        <div className="activity_list">
          ...
          <br />
          <img src={mypage_pink} alt="pink" width="553" height="130" />
          <br />
          <img src={mypage_blue} alt="blue" width="553" height="130" />
          <br />
          <img src={mypage_blue2} alt="blue2" width="553" height="130" />
          <br />
