    ...
    <div className="greenform">
      <div className="greenform_bg">
        ...
        <div className="greenform_content">
          <img
            src={green_alert_mentor}
            alt="green_alert_mentor"
            width="604"
            height="110"
          />
          <br />
          ...
          {/* 활동내용 */}
          <label className="green-label">
            위 활동에서의 구체적인 역할과 어떤 일을 했는 지 작성해주세요.{" "}
          </label>
          <textarea
          ...
          {/* 활동소감 (선택) */}
          <label className="green-label">
            창의적 체험활동과 관련해 기타 조언이 있다면 자유롭게 작성해주세요!
            (선택)
          </label>
          <textarea
